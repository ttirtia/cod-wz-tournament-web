<template>
  <div>
    <div class="flex flex-col flex-grow mx-auto max-w-6xl">
      ...
      <div v-if="!users.length" class="flex flex-col w-full mt-4 max-h-full">
        <p class="mt-16 flex-grow text-md">No user found</p>
      </div>
      <div v-if="users.length" class="flex flex-col w-full mt-6 max-h-full">
          ...
          <ul class="rounded divide-y divide-gray-200">
            ...
            >
              ...
              <div class="flex items-center space-x-4">
                ...
                <button @click="deleteUser(user.id)" class="focus:outline-none">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    fill="none"
                    viewBox="0 0 24 24"
